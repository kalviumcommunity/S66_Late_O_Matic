  ...
  return (
    <div className="h-screen bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 flex flex-col items-center justify-center text-white">
      ...
      <section className="flex justify-around w-full max-w-lg">
        <a href="/login" className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
          Log In
        </a>
        <a href="/signup" className="px-6 py-3 bg-pink-600 text-white rounded-lg shadow-lg hover:bg-pink-700 transition duration-300">
          Sign Up
        </a>
      </section>
